...
subsystems = [h1, ia1, sc, h2, h3, h4,h5,h7,ia3,ia2]
...
def total_heat_generated(heat_load, total_heat_loss):
    return heat_load + total_heat_loss
...
for heat_load in heat_loads:
    ...
    generated_heat = total_heat_generated(heat_load, total_heat_loss)
    total_heat_generated_values.append(generated_heat)
